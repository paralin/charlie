if (NOT WINCC)
  ...
  file(GLOB_RECURSE s_{MODULE_NAME}_SRC "${CHARLIE_SERVER_MODULE_PATH}/{MODULE_NAME}/*.cpp")
  add_library(s_{MODULE_NAME} SHARED ${s_{MODULE_NAME}_SRC} ${CHARLIE_MODULE_SRC}
    "{MODULE_NAME}.pb.redacted.cc")
  set_target_properties(s_{MODULE_NAME} PROPERTIES COMPILE_FLAGS "${MODULE_FLAGS} -DDO_CHARLIE_LOG -DCHARLIE_MODULE_NAME='\"{MODULE_NAME}\"'")
  ...
  add_custom_command(TARGET s_{MODULE_NAME} POST_BUILD
